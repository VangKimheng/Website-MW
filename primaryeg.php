...
<section class="px-5 pt-12 md:px-10 xl:px-20 lg:px-16">
        <div class="bg-[#ffffff] py-4 justify-center items-center rounded-[10px] border-[2px] xl:py-6 lg:py-5 md:py-4 ml:py-3 mt-20">
            <h1 class="text-center font-[poppins] text-[#083449] py-4 ml:p-2 mm:text-[20px] md:text-[20px] lg:text-[36px] font-medium">
                Primary School
            </h1>
        </div>
    </section>
    ...
    <div>
        <table class=" border border-[#525252] mt-6">
          ...
          <tbody>
            ...
            <td rowspan="2" class="border border-[#525252]">FYLE 1</td>
              <td class="border border-[#525252]">Next Move 1</td>
              <td rowspan="2" class="border border-[#525252]">9 Months</td>
            </tr>
            <tr class="tex6-[0.80rem] md:text-[1rem] xl:text-[1.2rem] text-[#525252] text-center h-[60px] md:h-[60px] xl:h-[90px] ">
              <td class="border border-[#525252]">Happy Campers 2nd Edition 1</td>
            </tr>
            <!--FYLE2-->
            <tr class="tex6-[0.80rem] md:text-[1rem] xl:text-[1.2rem] text-[#525252] text-center h-[60px] md:h-[60px] xl:h-[90px] ">
            <td rowspan="2" class="border border-[#525252]">FYLE 2</td>
              <td class="border border-[#525252]">Next Move 2</td>
              
              <td rowspan="2" class="border border-[#525252]">9 Months</td>
            </tr>
            <tr class="tex6-[0.80rem] md:text-[1rem] xl:text-[1.2rem] text-[#525252] text-center h-[60px] md:h-[60px] xl:h-[90px] ">
              <td class="border border-[#525252]">Happy Campers 2nd Edition 2</td>
            </tr>
            <!--FYLE3-->
            <tr class="tex6-[0.80rem] md:text-[1rem] xl:text-[1.2rem] text-[#525252] text-center h-[60px] md:h-[60px] xl:h-[90px] ">
            <td rowspan="2" class="border border-[#525252]">FYLE 3</td>
              <td class="border border-[#525252]">Next Move 3</td>
              
              <td rowspan="2" class="border border-[#525252]">9 Months</td>
            </tr>
            <tr class="tex6-[0.80rem] md:text-[1rem] xl:text-[1.2rem] text-[#525252] text-center h-[60px] md:h-[60px] xl:h-[90px] ">
              <td class="border border-[#525252]">Happy Campers 2nd Edition 3</td>
            </tr>
            <!--FYLE4-->
            <tr class="tex6-[0.80rem] md:text-[1rem] xl:text-[1.2rem] text-[#525252] text-center h-[60px] md:h-[60px] xl:h-[90px] ">
            <td rowspan="2" class="border border-[#525252]">FYLE 4</td>
              <td class="border border-[#525252]">Next Move 4</td>
              
              <td rowspan="2" class="border border-[#525252]">9 Months</td>
            </tr>
            <tr class="tex6-[0.80rem] md:text-[1rem] xl:text-[1.2rem] text-[#525252] text-center h-[60px] md:h-[60px] xl:h-[90px] ">
              <td class="border border-[#525252]">Happy Campers 2nd Edition 4</td>
            </tr>
            <!--FYLE5-->
            <tr class="tex6-[0.80rem] md:text-[1rem] xl:text-[1.2rem] text-[#525252] text-center h-[60px] md:h-[60px] xl:h-[90px] ">
            <td rowspan="2" class="border border-[#525252]">FYLE 5</td>
              <td class="border border-[#525252]">Next Move 5</td>
              
              <td rowspan="2" class="border border-[#525252]">9 Months</td>
            </tr>
            <tr class="tex6-[0.80rem] md:text-[1rem] xl:text-[1.2rem] text-[#525252] text-center h-[60px] md:h-[60px] xl:h-[90px] ">
              <td class="border border-[#525252]">Happy Campers 2nd Edition 5</td>
            </tr>
            <!--FYLE6-->
            <tr class="tex6-[0.80rem] md:text-[1rem] xl:text-[1.2rem] text-[#525252] text-center h-[60px] md:h-[60px] xl:h-[90px] ">
            <td rowspan="2" class="border border-[#525252]">FYLE 6</td>
              <td class="border border-[#525252]">Next Move 6</td>
              
              <td rowspan="2" class="border border-[#525252]">9 Months</td>
            </tr>
            <tr class="tex6-[0.80rem] md:text-[1rem] xl:text-[1.2rem] text-[#525252] text-center h-[60px] md:h-[60px] xl:h-[90px] ">
              <td class="border border-[#525252]">Happy Campers 2nd Edition 6</td>
            </tr>
